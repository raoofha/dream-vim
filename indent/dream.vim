...
setlocal autoindent
setlocal indentexpr=GetDreamIndent(v:lnum)
" Make sure GetDreamIndent is run when these are typed so they can be
...
if exists('g:dream_indent_keep_current')
...
let s:SYNTAX_STRING = 'dream\%(String\|AssignString\|Embed\|Regex\|Heregex\|'
\                   . 'Heredoc\)'

" Syntax names for comments
let s:SYNTAX_COMMENT = 'dream\%(Comment\|BlockComment\|HeregexComment\)'
...
function! GetDreamIndent(curlnum)
